...
* 使用最新版[v2ray](https://github.com/v2fly/v2ray-core/releases),配置可参考：[v2fly/v2fly-examples](https://github.com/v2fly/v2ray-examples) && [lxhao61](https://github.com/lxhao61/integrated-examples)
* 安装:
```bash
